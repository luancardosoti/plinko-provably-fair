    ...
    <div className="mt-16 w-full max-w-6xl mx-auto">
      ...
      {history.length > 0 && (
        <div className="flex flex-col gap-2">
          <div className="grid grid-cols-6 tracking-tighter font-bold text-sm text-center text-muted-foreground bg-primary-800 rounded-lg py-4 px-8">
            <span className="text-sm text-left">GAME</span>
            <span className="text-sm text-left">PLAYER</span>
          ...
          {history.slice(0, 10).map((game, index) => (
            <div 
              key={game.id} 
              className={cn(
                "grid grid-cols-6 tracking-tighter font-bold text-sm text-center text-muted-foreground bg-primary-800 rounded-lg py-4 px-8 hover:filter hover:brightness-125 transition-all duration-300 items-center",
                {
            ...
            >
              ...
              <span className="text-sm text-left">{game.username}</span>
              ...
              <span className="text-sm">{game.multiplier}x</span>
              <div className={cn("text-sm flex items-center justify-center", {
